...
export function CapabilitiesOutro() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="font-medium">The future is unified.</span>
          <br />
        ...
        >
          These thirteen capabilities don't just coexist - they synergize.
          Together, they form a self-optimizing, self-correcting, and
          self-evolving intelligence that transcends traditional AI. Behind the
          scenes, we are continuously training our systems and refining for
          excellence.
        </motion.p>
        ...
        <motion.p
          ...
          className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-white/45"
        >
          Vaino is the first step in real Artificial Intelligence, and the
          pathway toward Artificial General Intelligence.
        </motion.p>
        ...
        <motion.p
          ...
          className="mt-16 font-serif text-2xl italic text-white/45 md:text-3xl"
        >
...
export default CapabilitiesOutro;
